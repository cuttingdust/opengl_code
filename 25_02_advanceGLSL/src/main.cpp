...
//    Shader screenShader("../../shaders/screenShader.vs", "../../shaders/screenShader.fs");
    ...
    glBufferSubData(GL_ARRAY_BUFFER, sizeof(cubeVertices) / 2, sizeof(cubeVertices) / 2, &cubeVertices[sizeof(cubeVertices) / sizeof(float) / 2]);
...
//    screenShader.setInt("screenTexture", 0);
    ...
    unsigned int uniformShader = glGetUniformBlockIndex(ourShader.id_, "Matrices");
    
    unsigned int uniformSkyBoxShader = glGetUniformBlockIndex(skyboxShader.id_, "Matrices");
    
    glUniformBlockBinding(ourShader.id_, uniformShader, 1);
    glUniformBlockBinding(skyboxShader.id_, uniformSkyBoxShader, 1);
...
//                modelsIter->second.model_->Draw(shaderSingleColor);
//            }
//            glStencilFunc(GL_ALWAYS, 1, 0xFF);
//            glStencilMask(0xFF);
//        }
...
//        glDrawArrays(GL_TRIANGLES, 0, 6);
        ...
        // draw skybox as last
        glDepthFunc(GL_LEQUAL); // µ»”⁄µƒ ±∫Ú“≤pass
        skyboxShader.use();
