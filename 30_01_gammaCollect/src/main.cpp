...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
       ...
       ourShader.setMat4("view", view);
        // set light uniforms
       glUniform3fv(glGetUniformLocation(ourShader.id_, "lightPositions"), 4, &lightPositions[0][0]);
       glUniform3fv(glGetUniformLocation(ourShader.id_, "lightColors"), 4, &lightColors[0][0]);
       glUniform3fv(glGetUniformLocation(ourShader.id_, "lightColors"), 4, &lightColors[0][0]);
